...
export default async function JobDetailPage({ params }) {
  ...
  return (
    <main className="flex flex-col w-full bg-white relative min-h-screen">
      <div className="relative w-full overflow-hidden bg-[#0b2677]">
        {/* Background Pattern - Only for Blue Section */}
        <div
      ...
      <div className="relative z-10 w-full bg-[#fafafa]">
