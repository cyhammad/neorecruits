      ...
      <div className="relative flex flex-col h-full bg-white rounded-2xl border border-gray-100 group-hover:border-transparent overflow-hidden transition-all duration-500">
        ...
        <div className="relative z-10 p-3 sm:p-6 flex flex-col h-full">
          ...
          <div className="flex items-center justify-between mb-3 sm:mb-5">
            <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full bg-[#0b2677]/5 group-hover:bg-[#9a01cd] transition-colors duration-500">
              <span className="w-1 sm:w-1.5 h-1 sm:h-1.5 rounded-full bg-[#9a01cd] group-hover:bg-white" />
              <span className="text-[8px] sm:text-[10px] font-bold uppercase tracking-widest text-[#0b2677]/70 group-hover:text-white transition-colors duration-500">
                {job.employmentType}
              </span>
            </div>
          ...
          <div className="mb-4 sm:mb-6">
            <h3 className="text-sm sm:text-[17px] font-extrabold text-[#0b2677] leading-tight mb-1.5 sm:mb-2.5 group-hover:text-[#0b2677] transition-colors duration-300 line-clamp-2">
              {job.title}
            </h3>
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              <p className="text-[10px] sm:text-xs font-semibold text-gray-400 group-hover:text-[#9a01cd] transition-colors duration-500 line-clamp-1">
                {job.company}
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-1.5 sm:gap-2 mb-auto">
            <div className="flex items-center gap-1 px-2 py-1 sm:px-3 sm:py-1.5 rounded-full bg-gray-50 group-hover:bg-[#0b2677]/5 text-[8px] sm:text-[10px] font-bold uppercase tracking-wide text-gray-400 group-hover:text-[#0b2677] transition-all duration-500 border border-transparent group-hover:border-[#0b2677]/10">
              <MapPin
                size={9}
          ...
          {/* Footer */}
          <div className="mt-4 sm:mt-6 pt-3 sm:pt-5 border-t border-gray-50 group-hover:border-[#9a01cd]/10 transition-colors duration-500">
            <div className="flex items-end justify-between">
              <div>
                <span className="block text-[8px] sm:text-[9px] font-bold uppercase tracking-widest text-gray-300 mb-0.5 sm:mb-1 group-hover:text-[#9a01cd]/50 transition-colors duration-500">
                  Salary Range
                </span>
                <span className="text-[11px] sm:text-sm font-extrabold text-[#0b2677] transition-colors duration-300">
                  {displaySalary}
                </span>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gray-50 group-hover:bg-[#9a01cd] flex items-center justify-center transition-all duration-500">
                  <ArrowRight
                    size={14}
