...
export function InsightsHero({ activeTab, setActiveTab, tabs }) {
  const activeTabLabel =
    tabs.find((t) => t.id === activeTab)?.label || "Insights";
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-10 relative z-10 flex-1 flex flex-col pt-24 pb-12">
        <div className="max-w-7xl mx-auto w-full flex-1 flex flex-col justify-center">
          <div className="max-w-4xl space-y-4 sm:space-y-6 mb-12">
            ...
            >
              Latest updates, industry trends, and success stories from
              NeoRecruits.
            </motion.p>
          </div>
        </div>
