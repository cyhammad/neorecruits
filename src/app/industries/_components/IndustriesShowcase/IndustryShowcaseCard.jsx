  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#0b2677] via-[#0b2677]/60 to-transparent opacity-80 transition-opacity duration-500 group-hover:opacity-95 group-active:opacity-95" />
      ...
      <div className="absolute bottom-0 left-0 right-0 p-8 z-10 flex flex-col justify-end h-full">
        ...
        <div className="translate-y-8 group-hover:translate-y-0 group-active:translate-y-0 transition-transform duration-500 ease-out">
          <p className="text-xs font-bold text-[#9a01cd] uppercase tracking-widest mb-2 opacity-80 group-hover:opacity-100 group-active:opacity-100 transition-opacity">
            {industry.stats}
          </p>
