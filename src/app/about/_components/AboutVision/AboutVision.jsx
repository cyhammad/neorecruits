...
export function AboutVision() {
  return (
    <section className="py-24 bg-white overflow-hidden font-medium text-[#0f1d2d]">
      <div className="container mx-auto px-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <h2 className="text-3xl md:text-3xl lg:text-4xl font-extrabold tracking-tight uppercase leading-tight">
              Our Vision
            </h2>
            <div className="space-y-6 text-[#0f1d2d]/70 text-sm md:text-base leading-relaxed">
              <p>
