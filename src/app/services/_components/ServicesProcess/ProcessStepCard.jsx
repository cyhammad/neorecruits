    ...
    <div className="relative group">
      <div className="bg-white rounded-xl p-4 sm:p-8 shadow-lg hover:shadow-xl transition-all duration-300 h-full flex flex-col space-y-3 sm:space-y-4 border border-[#e5e5e5] hover:border-[#9a01cd]/20">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-2xl sm:text-5xl font-black text-[#0b2677]/5 /10 transition-colors duration-300">
            {String(step.id).padStart(2, "0")}
          </span>
        </div>
        <h3 className="text-sm sm:text-xl font-bold text-[#0b2677]  transition-colors duration-300 leading-tight">
          {step.title}
        </h3>
