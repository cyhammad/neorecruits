          ...
          <div className="bg-white/10 backdrop-blur-xl rounded-2xl sm:rounded-[2rem] p-8 sm:p-12 md:p-16 border border-white/20 shadow-2xl">
            <div className="text-center space-y-6 sm:space-y-8">
              ...
              <p className="text-white/80 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed font-medium">
                Let's discuss how our comprehensive recruitment services can
                help you build high-performing teams and drive business growth.
              </p>
              ...
              <div className="flex items-center justify-center gap-6 pt-6 border-t border-white/10">
                <a
                  ...
                  className="flex items-center gap-2 text-white/70 hover:text-white transition-colors text-sm sm:text-base font-medium"
                >
