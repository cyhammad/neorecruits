...
export function ServiceDetailHero({ slug }) {
  ...
  return (
    <section className="relative pt-32 sm:pt-40 pb-16 sm:pb-24 h-[60vh] min-h-[500px] w-full flex flex-col overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-10 relative z-10 flex-1 flex flex-col justify-center">
        <div className="max-w-7xl mx-auto w-full">
          <div className="max-w-3xl space-y-4 sm:space-y-6">
            <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight text-white uppercase">
              {title}
            </h1>
            <p className="text-lg sm:text-xl md:text-2xl text-white/80 leading-relaxed max-w-2xl font-medium italic">
